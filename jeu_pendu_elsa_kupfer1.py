...
def retourner_mot(fichier="Liste_mots.txt", dossier="/Users/elsakupfer/Documents/ETS/ETE/MGA802/Pendu 2"):
    import os
...
# change les lettres avec accents par des lettres sans accent
    ...
    mot = random.choice(liste_sans_accents)
    #print(mot)
    return  mot
...
fichier = input ('nom du fichier texte :')
dossier = input ('nom du dossier :')
mot = retourner_mot(fichier, dossier)
...
# source : Cours de Marlene Sanjose